        ...
        children: <Widget>[
          Material(
            child: new Container(
              ...
              child: new IconButton(icon: new Icon(Icons.face), onPressed: () => {} ,color: Palette.primaryColor),
            ),
            color: Colors.white,
          ),
          Flexible(
          ...
          Material(
            child: new Container(
              ...
              child: new IconButton(icon: new Icon(Icons.send), onPressed: () => {}, color: Palette.primaryColor),
            ),
            color: Colors.white,
          )
        ],
